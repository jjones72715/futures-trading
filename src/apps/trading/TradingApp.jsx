    ...
    try {
      ...
      const mapEval = r => {
        ...
        return {
          ...
          trader: traderId,
          status: f["Status"]?.name || f["Status"] || "",
          bal: (Array.isArray(f["Starting Balance"]) ? f["Starting Balance"][0] : f["Starting Balance"]) || 0,
          ddLeft: 0,
          ddToFloor: 0,
          prog: 0,
          limit: f["Max Trade Size"] || 0,
